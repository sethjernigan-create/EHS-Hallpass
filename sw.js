...
const CACHE='hall-camera-v4-roster';
const FILES=['./','./index.html','./mobile.css','./hall-core.js','./camera.js','./roster-core.js','./roster.js','./vendor/zxing-browser.min.js','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
